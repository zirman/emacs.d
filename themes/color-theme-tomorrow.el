...
(defconst color-theme-tomorrow-colors
  '((night . (;(background . "#dfdbc3");(background . "#1d1f21")
              (current-line . "#efefef");(current-line . "#282a2e")
              (selection . "#e5e5e5");(selection . "#373b41")
              (foreground . "#3b2322");(foreground . "#c5c8c6")
              (comment . "#7f2a19");(comment . "#969896")
              (red . "#990000");(red . "#cc6666")
              (orange . "#de935f")
              (yellow . "#999900");(yellow . "#f0c674")
              (green . "#00a600");(green . "#b5bd68")
              (aqua . "#00a6b2");(aqua . "#8abeb7")
              (blue . "#0000b2");(blue . "#81a2be")
              (purple . "#b200b2");(purple . "#b294bb")
              ))
    ...
    (night-bright . (;(background . "#000000")
                     (current-line . "#efefef");(current-line . "#2a2a2a")
                     (selection . "#eeeeee");(selection . "#424242")
                     (foreground . "#eaeaea")
                     (comment . "#969896")
                     (red . "#d54e53")
                     (orange . "#e78c45")
